  ...
  if (kIsWeb) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyDil8BjO5b4Ht0og2rB7pQwd78FrBSspws",
        appId: "1:620017271971:web:442a7a47060e0f648a6b16",
        messagingSenderId: "620017271971",
        projectId: "myband-5e8c5",
        storageBucket: "myband-5e8c5.appspot.com",
      ),
    );
  } else {
    await Firebase.initializeApp();
